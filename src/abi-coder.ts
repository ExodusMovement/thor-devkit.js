...
export { formatSignature } from '@exodus/ethers/utils/abi-coder'
import { defaultCoerceFunc } from '@exodus/ethers/utils/abi-coder'
import { CoerceFunc, ParamType } from '@exodus/ethers/utils/abi-coder' // types

// Reduced copy of https://github.com/vechain/ethers.js/blob/4313595f78c75a60639ad55b86634dd135e217a1/src.ts/utils/abi-coder.ts

import { NegativeOne, Zero, One, MaxUint256 } from '@exodus/ethers/constants';
import * as errors from '@exodus/ethers/errors';
import { bigNumberify } from '@exodus/ethers/utils/bignumber';
import { arrayify, concat, hexlify, padZeros } from '@exodus/ethers/utils/bytes';
import { toUtf8Bytes, toUtf8String } from '@exodus/ethers/utils/utf8';
import { deepCopy, defineReadOnly, shallowCopy } from '@exodus/ethers/utils/properties';
import { Arrayish } from '@exodus/ethers/utils/bytes';
import { BigNumberish } from '@exodus/ethers/utils/bignumber';
